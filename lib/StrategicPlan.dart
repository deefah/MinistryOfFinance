...
class StrategicPlan extends StatefulWidget {
  const StrategicPlan({super.key});

  @override
  State<StrategicPlan> createState() => _StrategicPlanState();
}

class _StrategicPlanState extends State<StrategicPlan> {
                ...
                child: GestureDetector(
                  onTap: () {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => StrategicPlan2(),
                        ));
                  },
                  child: const Row(
